...
**Project repository:**  
[https://github.com/ILCG-wyp/DRGNet](https://github.com/ILCG-wyp/DRGNet)
...
Please download 3DMatch from the official dataset page:  
[http://3dmatch.cs.princeton.edu/](http://3dmatch.cs.princeton.edu/)

You can also prepare the processed 3DMatch data following the standard setting used in GeoTransformer / PARE-Net-style evaluation.
...
Please download KITTI from the official dataset page:  
