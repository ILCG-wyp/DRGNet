...
# data
_C.data = edict()
_C.data.dataset_root = '/mnt/e/PCRproject3/PARENet-main/datasets/3DMatch'
...
_C.geotransformer.use_enhanced = True  # 直接启用增强版
_C.geotransformer.ppf_hidden_dim = 64  # PPF编码维度
...
_C.fine_matching.use_geometry_enhance = True  # 是否使用几何增强
_C.fine_matching.enhance_dim = 64            # 几何特征维度
_C.fine_matching.hidden_dims = [16, 32, 64]  # 几何增强模块的隐藏层维度
